...
% P4 is not a built-in listings language, so define it here
\lstdefinelanguage{P4}{
  morekeywords={action,actions,apply,bit,bool,const,control,default,default_action,
    else,enum,error,exit,extern,extract,emit,false,header,header_union,if,in,inout,
    key,out,package,parser,return,select,size,state,struct,switch,table,transition,
    true,typedef,varbit,verify,void},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
  sensitive=true
